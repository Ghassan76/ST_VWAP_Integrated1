...
bool InitializeIndicator()
{
   g_indicatorHandle = iCustom(_Symbol,_Period,"ST_VWAP_Integrated1",
      ST_ATRPeriod,ST_Multiplier,ST_Price,ST_Filling,
      VWAP_PriceMethod,VWAP_MinVolume,VWAP_ShowWeekly,VWAP_ShowMonthly,
      VWAP_FilterDaily,VWAP_FilterWeekly,VWAP_FilterMonthly,
      AVWAP_Session_Enable,AVWAP_Session_Hour,AVWAP_Session_Min,
      AVWAP_Session_Color,AVWAP_Session_Filter,
      Show_VWAP_Line,Show_Arrows,BullArrowColor,BearArrowColor,RejectArrowColor,
      ArrowCodeUp,ArrowCodeDn,
      Alert_Enabled,Alert_Popup,Alert_Sound,Alert_SoundFile,Alert_OnlyAccepted,
      Alert_Long,Alert_Short,Alert_OnlyInSession,Alert_OncePerBar,
      Alert_CooldownSeconds,Alert_Prefix,Alert_PointsFormat,Alert_UniqueID,
      Show_Debug,ResetStatsOnAttach,
      Dash_Enable,Dash_FontSize,Dash_TextColor,Dash_X,Dash_Y,Dash_BgColor,
      Dash_BorderColor,Dash_Corner,Dash_Width,Dash_Height,MFE_LookaheadBars,
      Session_Enable,Session_StartHour,Session_StartMinute,Session_EndHour,
      Session_EndMinute,Session_Mode,
      Dash_Font,Dash_LabelFontSize,Dash_ValueFontSize,Dash_LabelXOffset,
      Dash_ValueXOffset,Dash_AccentColor,Dash_GoodColor,Dash_BadColor,
      Dash_MutedColor,Dash_BullishColor,Dash_BearishColor,Dash_AvgColor,
      Dash_SpacerLines,Dash_RowGapPixels);

   if(g_indicatorHandle==INVALID_HANDLE)
   {
      Print("Failed to create ST_VWAP_Integrated1 indicator. Error: ",GetLastError());
      return(false);
   }
